...
if __name__ == "__main__":
    dataset_reader = DatasetReader("../generalDF/one_hot_words_df/bow1")
    data = dataset_reader.read_pkl_file(dataset_reader.get_file_names()[0])
    ...
    for file_name in all_names:
        ...
        # print(data.loc["PC-1"])
        print(data.loc["PC-2"].sort_values())
